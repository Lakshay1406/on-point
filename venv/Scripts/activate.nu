...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Laptop\PycharmProjects\on-point\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Laptop\PycharmProjects\on-point\venv\Scripts\deactivate.nu'
